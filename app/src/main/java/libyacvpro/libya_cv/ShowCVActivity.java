...
public class ShowCVActivity extends AppCompatActivity {
    ...
    private static final String TAG = "ShowCVActivity";
    ...
    private void ShowSQLiteDBdata() {
        ...
        if(tokenManager.getToken() == null){
            startActivity(new Intent(ShowCVActivity.this, LoginActivity.class));
            finish();
        }
    ...
    private void setData(List<Seeker> s){
        ...
        ListAdapter = new AppCvAdapter(ShowCVActivity.this,
                itemID,
                userID,
        tvName,
        tvDomain,
