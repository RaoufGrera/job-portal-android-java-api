...
public class CompanyJobsActivity extends AppCompatActivity {
    private NonScrollListView lvItems;
    private static final String TAG = "CompanyJobsActivity";
    ...
    private void apiLoad(){
        ...
        if(tokenManager.getToken() == null){
            startActivity(new Intent(CompanyJobsActivity.this, LoginActivity.class));
            finish();
        }
