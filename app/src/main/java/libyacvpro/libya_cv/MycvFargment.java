...
public class MycvFargment extends AppCompatActivity {
    ...
    TextView lblSeeIT,txtInfo,txtEdu,txtExp,txtSpec,txtSkills,txtHobby,txtTra,txtCert,txtLang,lblName,lblMatch,lblCity,lblPhone,lblEmail,lblDomain;
    ...
    Button btnNewImage,btnNew,btnNewExp,btnNewLang,btnNewSkills,btnNewCert,btnNewInfo,btnNewSpec,btnNewHobby,btnNewSeeker,btnNewTra;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(tokenManager.getToken() == null){
            startActivity(new Intent(MycvFargment.this, LoginActivity.class));
           finish();
        }
    /*    MobileAds.initialize(getContext(), APP_ID);
        ...
        lblSeeIT = (TextView) findViewById(R.id.lblSeeIT);
        ...
        btnNewImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, EditImageSeekerActivity.class);
        ...
        btnNewSeeker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, SeekerActivity.class);
                intent.putExtra("id", 0);
                startActivityForResult(intent,0);
            }});
        ...
        btnNew.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, EditAddEducationActivity.class);
                intent.putExtra("id", 0);
                startActivityForResult(intent,0);
            }});
        ...
        btnNewExp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, AddEditExperienceActivity.class);
                intent.putExtra("id", 0);
                startActivityForResult(intent,0);
            }});
        ...
        btnNewLang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, AddEditLanguageActivity.class);
                intent.putExtra("id", 0);
                startActivityForResult(intent,0);
            }});
        ...
        btnNewSkills.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, AddEditSkillsActivity.class);
                intent.putExtra("id", 0);
                startActivityForResult(intent,0);
            }});
        ...
        btnNewCert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, AddEditCertificateActivity.class);
                intent.putExtra("id", 0);
                startActivityForResult(intent,0);
            }});
        ...
        btnNewInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, AddEditInfoActivity.class);
                intent.putExtra("id", 0);
                startActivityForResult(intent,0);
            }});
        ...
        btnNewSpec.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, AddEditSpecialtyActivity.class);
                intent.putExtra("id", 0);
                startActivityForResult(intent,0);
            }});
        ...
        btnNewHobby.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, AddEditHobbyActivity.class);
                intent.putExtra("id", 0);
                startActivityForResult(intent,0);
            }});
        ...
        btnNewTra.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MycvFargment.this, AddEditTrainingActivity.class);
                intent.putExtra("id", 0);
                startActivityForResult(intent,0);
            }});
   ...
   /* @Override
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
       ...
       // super.onCreateOptionsMenu(menu, inflater);
        menu.clear();
        inflater.inflate(R.menu.side_bar_pdf, menu);
    }*/
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.toolpdf:
                ...
                Intent intent = new Intent(MycvFargment.this, SeekerPDFActivity.class);
                 startActivityForResult(intent,0);
                return true;
    ...
    public void onResume() {
        super.onResume();
        MycvFargment.this.setTitle("السيرة الذاتية");
    }
...
//        TransitionManager.beginDelayedTransition(container);
    ...
    public boolean isOnline() {
        ...
        try {
            ConnectivityManager cm =
                    (ConnectivityManager) MycvFargment.this
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        getMenuInflater().inflate(R.menu.side_bar_pdf,menu);
        return true;
    }
    ...
    private void setData(ShowCvResponse objSeeker){
        ...
        lblSeeIT.setText(objJobSeeker.getSee_it());
        ...
        if( lstEdu.size() > 0) {
            ...
            ListAdapterAuth = new EducationAuthAdapter(
                    MycvFargment.this,EditAddEducationActivity.class, SectionEnum.EDUCATION.getSectionLetter(),
        ...
        if( lstExp.size() > 0) {
            ...
            ListAdapterAuth = new EducationAuthAdapter(
                    MycvFargment.this,AddEditExperienceActivity.class,SectionEnum.EXPERIENCE.getSectionLetter(),
        ...
        if( lstLang.size() > 0) {
            ...
            for (int i = 0; i < lstLang.size(); i++)
            {
                ...
                secondLang.add("");
                IdsLang.add(new IntegrString(lstLang.get(i).getJob_lang_id(),""));
            ...
            ListAdapterAuth = new EducationAuthAdapter(
                    MycvFargment.this,AddEditLanguageActivity.class,SectionEnum.LANGUAGE.getSectionLetter(),
        ...
        if( lstSpec.size() > 0) {
            ...
            ListAdapterAuth = new EducationAuthAdapter(
                    MycvFargment.this,AddEditSpecialtyActivity.class,SectionEnum.SPECIALTY.getSectionLetter(),
        ...
        if( lstSkills.size() > 0) {
            ...
            ListAdapterAuth = new EducationAuthAdapter(
                    MycvFargment.this,AddEditSkillsActivity.class,SectionEnum.SKILLS.getSectionLetter(),
        ...
        if( lstCert.size() > 0) {
            ...
            ListAdapterAuth = new EducationAuthAdapter(
                    MycvFargment.this,AddEditCertificateActivity.class,SectionEnum.CERTIFICATE.getSectionLetter(),
        ...
        if( lstTra.size() > 0) {
            ...
            ListAdapterAuth = new EducationAuthAdapter(
                    MycvFargment.this,AddEditTrainingActivity.class,SectionEnum.TRAINING.getSectionLetter(),
        ...
        if( lstHobby.size() > 0) {
            ...
            for (int i = 0; i < lstHobby.size(); i++)
            {
                ...
                firstHobby.add(lstHobby.get(i).getHobby_name());
            ...
            ListAdapterAuth = new EducationAuthAdapter(
                    MycvFargment.this,AddEditHobbyActivity.class,SectionEnum.Hobby.getSectionLetter(),
        ...
        if( lstInfo.size() > 0) {
            ...
            ListAdapterAuth = new EducationAuthAdapter(
                    MycvFargment.this,AddEditInfoActivity.class,SectionEnum.INFO.getSectionLetter(),
