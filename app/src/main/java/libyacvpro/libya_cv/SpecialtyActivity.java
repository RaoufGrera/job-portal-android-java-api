...
public class SpecialtyActivity extends AppCompatActivity {
    ...
    private void apiLoad(){
        ...
        if(tokenManager.getToken() == null){
            startActivity(new Intent(SpecialtyActivity.this, LoginActivity.class));
            finish();
        }

        service = RetrofitBuilder.createServiceWithAuth(ApiService.class, tokenManager);
        showLoading();
        call = service.specialty();
        call.enqueue(new Callback<SpecialtyResponse>() {
            @Override
            public void onResponse(Call<SpecialtyResponse> call, Response<SpecialtyResponse> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    List<Specialty> ee = response.body().getSpecialty();
                    setData(ee);
                    showForm();
    ...
    private void setData(List<Specialty> ee){
        ...
        {
            myLibrary.add(new IntegrString(ee.get(i).getSpec_seeker_id(),ee.get(i).getSpec_name()));
        }

        CustomAdpter adapter = new CustomAdpter(this,AddEditSpecialtyActivity.class, SectionEnum.SPECIALTY.getSectionLetter(), myLibrary);
    ...
    @OnClick(R.id.btnNew)
    void addNewItem(){
        Intent intent = new Intent(SpecialtyActivity.this, AddEditSpecialtyActivity.class);
