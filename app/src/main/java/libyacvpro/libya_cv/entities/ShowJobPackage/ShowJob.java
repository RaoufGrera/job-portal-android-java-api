...
public class ShowJob {
    ...
    public Integer getExp_min() {
        return exp_min;
    }

    public void setExp_min(Integer exp_min) {
        this.exp_min = exp_min;
    }

    public Integer getExp_max() {
        return exp_max;
    }

    public void setExp_max(Integer exp_max) {
    ...
    public Integer getReq_count() {
        return req_count;
    }

    public void setReq_count(Integer req_count) {
