...
public class LanguageActivity extends AppCompatActivity {
        ...
        call.enqueue(new Callback<LanguageResponse>() {
            ...
            public void onResponse(Call<LanguageResponse> call, Response<LanguageResponse> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    List<Language> ee = response.body().getLanguage();
                    setData(ee);
                    showForm();
    ...
    private void setData(List<Language> ee){
        ...
        {
            myLibrary.add(new IntegrString(ee.get(i).getJob_lang_id(),ee.get(i).getLang_name()));
        }

        CustomAdpter adapter = new CustomAdpter(this,AddEditLanguageActivity.class, SectionEnum.LANGUAGE.getSectionLetter(), myLibrary);
    ...
    @OnClick(R.id.btnNew)
    void addNewItem(){
        Intent intent = new Intent(LanguageActivity.this, AddEditLanguageActivity.class);
