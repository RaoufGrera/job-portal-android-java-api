...
public class EducationActivity extends AppCompatActivity {
    ...
    private void apiLoad(){
        ...
        if(tokenManager.getToken() == null){
            startActivity(new Intent(EducationActivity.this, LoginActivity.class));
            finish();
        }

        service = RetrofitBuilder.createServiceWithAuth(ApiService.class, tokenManager);
        showLoading();
        call = service.educations();
        call.enqueue(new Callback<EducationResponse>() {
            ...
            public void onResponse(Call<EducationResponse> call, Response<EducationResponse> response) {
                ...
                if(response.isSuccessful()){
                    ...
                    List<Education> ee = response.body().getEducation();
                    setData(ee);
                    showForm();
    ...
    private void setData(List<Education> ee){
        ...
        {
            myLibrary.add(new IntegrString(ee.get(i).getEd_id(),ee.get(i).getUniv_name()));
        }

        CustomAdpter adapter = new CustomAdpter(this,EditAddEducationActivity.class, SectionEnum.EDUCATION.getSectionLetter(), myLibrary);
    ...
    @OnClick(R.id.btnNew)
    void addNewItem(){
        Intent intent = new Intent(EducationActivity.this, EditAddEducationActivity.class);
